...
@Tag(name = "Promotores de Venda", description = "Operações de cadastro e manutenção dos promotores de venda.")
public class PromotorController {
    ...
    @Operation(summary = "Cadastrar promotor", description = "Cadastra um novo promotor.")
    @ApiResponse(responseCode = "200", description = "Promotor cadastrado com sucesso")
    @ApiResponse(responseCode = "400", description = "Dados inválidos para cadastro do promotor")
    @PostMapping
    public Promotor cadastrar(@RequestBody Promotor promotor) {
        return repository.save(promotor);
    }

    @Operation(summary = "Buscar promotor por ID", description = "Retorna os dados de um promotor pelo seu identificador.")
    ...
    @Operation(summary = "Atualizar promotor", description = "Atualiza os dados de um promotor existente.")
    ...
    @Operation(summary = "Excluir promotor", description = "Remove um promotor pelo seu identificador.")
